...
set xrange [ 0.000100000 : 0.0100000 ] noreverse nowriteback
...
P3 = 0.96
P4 = 0.92
plot (-a*(1-P1)+sqrt(a*a*(1-P1)*(1-P1)+4*(1-a*a)*x*P1))/(2*(1+a)*x) w l t "P=0.99, a=0.5", (-a*(1-P2)+sqrt(a*a*(1-P2)*(1-P2)+4*(1-a*a)*x*P2))/(2*(1+a)*x) w l t "P=0.98, a=0.5", (-a*(1-P3)+sqrt(a*a*(1-P3)*(1-P3)+4*(1-a*a)*x*P3))/(2*(1+a)*x) w l t "P=0.96, a=0.5", (-a*(1-P4)+sqrt(a*a*(1-P4)*(1-P4)+4*(1-a*a)*x*P4))/(2*(1+a)*x) w l t "P=0.92, a=0.5"
#    EOF
