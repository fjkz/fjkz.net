...
set raxis
set key title ""
set key inside right top vertical Left noreverse enhanced autotitles box linetype -1 linewidth 1.000
...
GNUTERM = "wxt"
plot 1/(0.01+0.99/x) w l t "P=0.99, c=0     ", 1/(0.01+0.99/x+0.0001*x) w l t "P=0.99, c=0.0001", 1/(0.01+0.99/x+0.001*x) w l t "P=0.99, c=0.001", 1/(0.01+0.99/x+0.01*x) w l t "P=0.99, c=0.01"
#    EOF
